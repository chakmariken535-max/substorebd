...
import { services, getWhatsAppLink } from '@/lib/services';
      ...
      <section className="max-w-[1200px] mx-auto px-8 py-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-gutter">
          {service.plans.map((plan, i) => (
            <div
              key={i}
              className={`relative glass-card rounded-2xl p-lg flex flex-col gap-6 text-center transition-all duration-300 hover:scale-[1.02] ${
                plan.popular ? 'ring-2' : ''
              }`}
