          ...
          {[
            ...
            <div key={screens} className={`relative glass-card rounded-2xl p-md text-center flex flex-col gap-4 transition-all duration-300 hover:border-primary-container/60 ${popular ? 'border-primary-container/40 ring-1 ring-primary-container/30' : ''}`}>
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 bg-primary-container/10 border border-primary-container/30 hover:bg-primary-container text-white hover:text-on-primary-container font-label-bold rounded-xl transition-all active:scale-95"
              >
